...
class Main extends JFrame {
	...
	public Main() throws ClassNotFoundException {
		...
		lblReportType.setBounds(26, 41, 114, 14);
		Report.add(lblReportType);
		
		JDateChooser expDateFrom = new JDateChooser();
		expDateFrom.setBounds(157, 41, 165, 20);
		...
		expDateTo.setBounds(357, 41, 165, 20);
		...
		lblIncomes.setFont(new Font("Tahoma", Font.BOLD, 13));
		...
		btnShowReport.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == btnShowReport) { // add new Category
					...
					String cond2="and cat.cat_type='E' and trans.user_id='"+userId+"' and trans.trans_date between '"+expDF+"' and '"+expDT+"'" ;
					List<Transaction> expenseList=sql.getIncomeSummary(cond2);
					String cond3="and cat.cat_type='I' and trans.user_id='"+userId+"' and trans.trans_date between '"+expDF+"' and '"+expDT+"'";
					...
					lblTotalSavingTxt.setText(String.valueOf(totalIncome-totalExpense));
				}
